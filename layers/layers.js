...
lyr__1.set('fieldLabels', {'name_ru': 'inline label - always visible', });
lyr__2.set('fieldLabels', {'name': 'inline label - always visible', });
lyr__3.set('fieldLabels', {'Name_ru': 'inline label - always visible', });
lyr_009_KIRBA_4.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_008_Koybal_5.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_001SB_002_6.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_003SM_001_7.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_002SM_001_8.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_001SM_001_9.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_003VB_001_10.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_002VB_001_11.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'С т': 'inline label - always visible', 'Регио': 'no label', });
lyr_001VB_001_12.set('fieldLabels', {'Class_Name': 'inline label - always visible', 'C т': 'inline label - always visible', 'Регио': 'no label', });
